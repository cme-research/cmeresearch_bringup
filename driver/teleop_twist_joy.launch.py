...
def generate_launch_description():
    ...
    return launch.LaunchDescription([
        launch.actions.DeclareLaunchArgument('joy_vel', default_value='/unicomini_base_controller/cmd_vel'),
        launch.actions.DeclareLaunchArgument('joy_config', default_value='pdp'),
        ...
        launch.actions.DeclareLaunchArgument('config_filepath', default_value=[
            launch.substitutions.TextSubstitution(text=os.path.join(
                get_package_share_directory('unico_bringup'), 'config', '')),
